"""
This script is intended solely for inserting papers in a simple manner without a
specifically crafted hash and without the correct authors. These details cannot
be easily extracted from the PDF files. The purpose of this script is to test the
general handling of files in the database and their connection with files in the
S3 storage. It also does not store or create embeddings for the paper.
"""
