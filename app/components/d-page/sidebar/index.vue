...
<template>
  <div class="flex">
    <header v-if="!isPublicRoute" class="flex w-full border-b border-gray-200 bg-gray-50 sm:hidden">
      <div
    ...
    <div
      v-if="mobileMenu"
      class="fixed top-0 left-0 z-50 flex h-full w-full flex-col justify-between bg-white sm:hidden"
    >
    ...
    <header
      v-if="!isPublicRoute"
      class="hidden flex-col justify-between border-r border-gray-200 bg-gray-50 sm:flex"
