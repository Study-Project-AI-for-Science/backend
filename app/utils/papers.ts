...
<span data-rid="13">Recurrent neural networks, long short-term memory[^13]</span> <span data-rid="7">and gated recurrent[^7]</span> neural networks in particular, have been firmly established as state of the art approaches in sequence modeling and transduction problems such as language modeling and machine translation[^35][^2][^5]. Numerous efforts have since continued to push the boundaries of recurrent language models and encoder-decoder architectures[^38][^24][^15].
