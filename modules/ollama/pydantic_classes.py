...
class PaperMetadata(BaseModel):
    ...
    authors: List[str] = Field(..., min_items=1, description="List of author names")
    ...
    keywords: List[str] = Field(..., min_items=3, description="List of keywords related to the paper")
